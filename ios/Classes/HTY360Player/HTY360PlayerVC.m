...
- (void)configureImages {
    ...
    self.playbackPlayImg = [UIImage imageNamed:@"play" inBundle:bundle compatibleWithTraitCollection:nil];
    self.playbackPauseImg = [UIImage imageNamed:@"pause" inBundle:bundle compatibleWithTraitCollection:nil];
